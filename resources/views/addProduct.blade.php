...
<div class="container form-section">
  <h2 class="mb-4 text-center fw-bold" style="color: #594431;">Aggiungi un nuovo prodotto</h2>
  <form method="POST" enctype="multipart/form-data">
    <div class="row g-4">
      <!-- Sezione Immagini -->
      <div class="col-md-6">
        <label class="form-label fw-semibold">Foto del prodotto</label>
        <!-- Upload fittizio + slider -->
        ...
        <!-- Slider (solo a scopo dimostrativo) -->
      ...
      <div class="col-md-6">
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control" id="productPrice" name="prezzo" step="0.01">
        </div>
        ...
        <div class="mb-3">
          ...
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" id="intensita1" name="intensita[]" value="Morbido">
            <label class="form-check-label" for="intensita1">Morbido</label>
          </div>
          <div class="form-check form-check-inline">
